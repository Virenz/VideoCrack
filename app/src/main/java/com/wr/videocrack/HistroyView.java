...
public class HistroyView extends ViewGroup {
    ...
    public HistroyView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HistroyView(Context context, AttributeSet attrs, int defStyle) {
